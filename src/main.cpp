...
uint256 hashGenesisBlock("0xdd9e932054ee5fcd5c96a892f776ab4c6002e15093da93df8c5a567544a99aca");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 11)   // the first 10 special blocks for bounty.
    {
        nSubsidy = 10000 * COIN;
    }
    else if(nHeight < 1441)   // Day 1
    {
        nSubsidy = 80 * COIN;
    }
    else if(nHeight < 2881)   // Day 2
    {
        nSubsidy = 60 * COIN;
    }
    else if(nHeight < 5761)   // Day 3
    {
        nSubsidy = 40 * COIN;
    }
	else if(nHeight < 11520) //Day 4
	{
	   nSubsidy = 20 * COIN;
	}
    else
    {
    // Subsidy is cut in half every 2600000 blocks, which will occur approximately every 5 years
    nSubsidy >>= (nHeight / 26000000); // Boxcoin: 2.6 Million blocks in ~5 years
    }
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 60; // Boxcoin: Every Block 
static const int64 nTargetSpacing = 1 * 60; // Boxcoin: 1 minute
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal boxcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7af313ccd71c3c001daf672ae479eeae28abab15622e1eb4a78ef8554c37133f");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1374990556; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 755215;

        if (fTestNet)
        {
            block.nTime    = 1374988870;
            block.nNonce   = 917372;
        }
